...
export default function Cv_card_loading() {
    return (
        <div className='w-full flex flex-col p-6'>
            <div role='status' className='flex w-full animate-pulse'>
                <div className='flex-shrink-0'>
                    <span className='flex justify-center items-center bg-gray-300 rounded-full w-22 h-22 '></span>
                </div>
                <div className='ml-4 mt-2 w-full'>
                    <h3 className='h-3 bg-gray-300 rounded-full  w-[70%] mb-4'></h3>
